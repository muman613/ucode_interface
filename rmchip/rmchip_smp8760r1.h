...
#ifndef __SMP8760R1_H__
#define __SMP8760R1_H__ 1

#include "rmchip_common.h"

#define XBOOT4_VERSION 0x009

#define XPU_INS_SCRATCHPAD_SIZE 0x8000
#define XPU_DAT_SCRATCHPAD_SIZE 0x6000
#define AUDIO_DM_SIZE DMEM_SIZE_audio_engine_0
#define AUDIO_PM_SIZE PMEM_SIZE_audio_engine_0
...
#define DEMUX_DM_SIZE DMEM_SIZE_demux_engine_0
#define DEMUX_PM_SIZE PMEM_SIZE_demux_engine_0
#define FG_SIZE 0x5000
#define IOSVA_TEXT 0xddc00000
#define LOG2_IOS 0x15
#define MAIN_MIXER_CHANNEL_COUNT 8
#define MPEG_DM_SIZE DMEM_SIZE_mpeg_engine_0
#define MPEG_PM_SIZE PMEM_SIZE_mpeg_engine_0
#define RMCHIP_AUDIO_ENGINE_COUNT 2
#define RMFEATURE_HAS_AUDIO_ENGINE_1 1
#undef RMCHIP_AUDIO_ENGINE_VERSION
#define RMCHIP_AUDIO_ENGINE_VERSION 3
#define RMCHIP_CPU_ARCH RMCHIP_ARCH_ARM_TOKEN
...
#define RMCHIP_BVP_DISPLAY_VERSION 4     // DFD 0,1,2,4,10,11 have 10bit; DFD 7,8 have 12 bit; ...
#define RMCHIP_DRAM_CONTROLLER_COUNT 2
#define RMCHIP_GPU_ARCH RMCHIP_GPU_ARCH_MALI400MP4_TOKEN
#define RMCHIP_L2_CACHE_PRESENT 1
#define RMCHIP_OTP_PRESENT 1
#define RMCHIP_OTP_CONTROLLER_VERSION 2
#define RMCHIP_OTP_LOGICAL_BYTESIZE 0x2000 /* logical OTP size */
#define RMCHIP_REVISION 1
#define RMCHIP_VIDEO_ENGINE_COUNT 1
#define RMCHIP_CPU_HAS_GBUS_BURST 1
#define RMCHIP_VIDEO_ENGINE_0_VERSION 16
#define RMCHIP_VIDEO_ENGINE_H265_INDEX 0    // index of video engine that supports H265
#define RMCHIP_VIDEO_ENGINE_VERSION      RMCHIP_VIDEO_ENGINE_0_VERSION     // supports both legacy and H265
#undef RMTILE_WIDTH_SHIFT
#undef RMTILE_SIZE_SHIFT
#define RMTILE_WIDTH_SHIFT 9
#define RMTILE_SIZE_SHIFT 14
...
#define RMFEATURE_DemuxEngine_HAS_ASA_CIPHER 1
...
#define RMCHIP_ROM_SIZE (82*1024)
...
#define RMCHIP_CLOCK_GENERATOR_BLOCK_VERSION 2
#define RMFEATURE_MLC_GF15 1
#define RMFEATURE_WITH_UART_SYNC 1
#define RMFEATURE_VideoDecoder_HAS_DRAM_MUX_FOR_MOTION_COMP 1
#define RMFEATURE_HAS_MONTGOMERY_RSA_ACC 1
#undef RMFEATURE_IVREG_UNCHANGED_BY_ECB
#define RMCHIP_HAS_SECURE_STR_SUPPORT 1
#define SCRAMBLING_KEY_SIZE (1<<4) /* 128 bits in bytes */
#define RMCHIP_HAS_TANGO5_GBUS_MAP 1

#endif /* __SMP8760R1_H__ */
