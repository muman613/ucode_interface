...
/* Overlaps LR_CPULAUNCH_CODE, but that's only for SMP8910/SMP8920.  This is only for SMP87xx onwards that use MLC_GF15 controller.
   See bug#41103, comment#22.  The original LR_MLC_GF15 location gets trashed by an xload processing.
 */
#define LR_MLC_GF15_COPY         0x000008e4 /* 28 bytes... to 0x08fc]. */
...
#define MAX_LRRW_SIZE (LR_XOS_DUMP-LR_XENV2_RW)
