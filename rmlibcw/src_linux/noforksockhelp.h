...
int get_connection(int socket_type, u_short port, char *netaddress);
int make_connection(u_short port, int type, char *netaddress);
int make_connection_WithTimeout(u_short port, int type, char *netaddress, int connect_timeout);
