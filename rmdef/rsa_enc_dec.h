...
#define MAX_SIZE 64
typedef RMuint32 romkey[64];

int lt(const RMuint32 *x,RMuint32 sx,const RMuint32 *y,RMuint32 sy);
int checkparm_rsa_enc_dec(RMuint32 *c,const RMuint32 *m,RMuint32 msize,const RMuint32 *_e, RMuint32 esize);
void rsa_enc_dec(RMuint32 *c,const RMuint32 *m,RMuint32 msize,const RMuint32 *e,RMuint32 esize);
